...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\EnquestaType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EnquestaType']) ? $this->services['AppBundle\Form\EnquestaType'] : $this->services['AppBundle\Form\EnquestaType'] = new \AppBundle\Form\EnquestaType()) && false ?: '_'};
}, 'AppBundle\\Form\\EnquestaTypeEdicio' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EnquestaTypeEdicio']) ? $this->services['AppBundle\Form\EnquestaTypeEdicio'] : $this->services['AppBundle\Form\EnquestaTypeEdicio'] = new \AppBundle\Form\EnquestaTypeEdicio()) && false ?: '_'};
}, 'AppBundle\\Form\\EnquestaTypeUpdate' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EnquestaTypeUpdate']) ? $this->services['AppBundle\Form\EnquestaTypeUpdate'] : $this->services['AppBundle\Form\EnquestaTypeUpdate'] = new \AppBundle\Form\EnquestaTypeUpdate()) && false ?: '_'};
}, 'AppBundle\\Form\\UsuariType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\UsuariType']) ? $this->services['AppBundle\Form\UsuariType'] : $this->services['AppBundle\Form\UsuariType'] = new \AppBundle\Form\UsuariType()) && false ?: '_'};
