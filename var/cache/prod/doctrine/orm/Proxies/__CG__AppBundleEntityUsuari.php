...
class Usuari extends \AppBundle\Entity\Usuari implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuari' . "\0" . 'plainPassword', '' . "\0" . 'AppBundle\\Entity\\Usuari' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\Usuari' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Usuari' . "\0" . 'admin', '' . "\0" . 'AppBundle\\Entity\\Usuari' . "\0" . 'id'];
        }
